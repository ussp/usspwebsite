...
description: "Step-by-step guide for deploying the AI Transformation Framework for a new engagement"
---
...
- [ ] Client's project methodology is known (SAFe, Scrum, Kanban, etc.)
...
| 9 | **Pull baseline metrics** -- work tracking data for last 3 sprints, all teams | [Ch 5](05-baseline-measurement.md) |
...
| 14 | **Map SDLC processes** -- current state to AI-augmented state per role | [Ch 6](06-process-design.md) |
...
| Step | Action | Reference |
|------|--------|-----------|
| 22 | **Launch pilot** -- announce to organization, brief pilot teams | [Ch 8](08-pilot-execution.md) |
...
| 27 | **Post-pilot measurement** -- automated data pull + SPACE/DevEx resurvey | [Ch 9](09-measurement-reporting.md) |
...
1. **Create tenant** (if new client) -- see AI Tools Tenant Onboarding documentation
2. **Create engagement** -- name, client, teams, iteration cycle dates
3. **Configure work tracking integration** -- API credentials, project keys
4. **Create baseline assessment** -- automated (work tracking tool) + manual (surveys)
5. **Generate training plan** -- customize based on [Chapter 7](07-training-delivery.md)
6. **Share dashboard** -- generate read-only URL for executive sponsor
...
│   ├── guide/                   <- Copy and customize the framework guide
