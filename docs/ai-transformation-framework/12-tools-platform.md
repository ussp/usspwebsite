...
description: "AI Transformation Monitor user guide, dashboard configuration, and tooltips"
---
...
The AI Transformation Monitor at **tools.ussp.co** is the platform that powers assessment tracking, training plans, measurement, and executive reporting. This chapter is the user guide for the platform.
...
| **Reports** | Before/after comparison with DORA, SPACE, DevEx metrics | AI Transformation Leader, Executive Sponsor |
| **Dashboard** | Real-time engagement status and improvement tracking | Executive Sponsor, Engagement Director |

## Getting Started

1. Navigate to [tools.ussp.co](https://tools.ussp.co)
2. Log in with your Google or Microsoft account
3. Select the appropriate engagement from the dashboard
...
- **Name:** Descriptive engagement name (e.g., "[Client] -- AI Pilot")
- **Client:** Client organization name
- **Teams:** Add pilot teams + control teams
- **Iteration cycle:** Specify the start and end dates
...
**Customize** the auto-generated plan to match the training delivery plan in [Chapter 7](07-training-delivery.md).

### Step 4: Post-Training Assessment

After the pilot cycle completes:
...
| **Trend** | Sprint-over-sprint progress during pilot cycle |
| **Compliance** | Policy compliance status (green/yellow/red) |

Access: Read-only URL shared with executive sponsor. No login required for view-only access.
