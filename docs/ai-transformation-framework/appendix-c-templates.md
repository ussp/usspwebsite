---
title: "Templates"
description: "Survey templates, report templates, prompt library structure, and cheat sheets"
---

# Appendix C: Templates Collection
...
This condensed version is for quick reference when setting up the electronic survey form.
...
### Section E: Infrastructure Readiness (3 questions, team-level, completed by team lead)

```
E1. AI code assistant access:  [ ] All members  [ ] Some  [ ] Requested  [ ] No  [ ] Unsure
E2. AI productivity tool access:  [ ] Enabled  [ ] Partial  [ ] Available  [ ] No  [ ] Unsure
...
> **Reference:** Forsgren et al. (2021) -- see [Appendix B](appendix-b-research-citations.md), Citation 2.
...
> **Reference:** Developer Experience research -- see [Appendix B](appendix-b-research-citations.md), Citation 2 (SPACE/DevEx).
...
> **Reference:** Chapter 9, Measurement & Reporting

**Audience:** Engagement Director, AI Transformation Leader, pilot team Scrum Masters
**Cadence:** Weekly (updated each Friday)
**Format:** Shared document, not sent to executive sponsor unless requested

```
Weekly Check-In Report
=======================

Week of: _______________              Sprint: _____ of _____
...
> **Reference:** Chapter 9, Measurement & Reporting (administered at sprint midpoint)

**Audience:** Pilot team members only
**Timing:** After sprint 3 retrospective (or midpoint of pilot)
**Estimated completion time:** 3-5 minutes
...
Q1. The AI tools are helping me be more productive in my
...
Location:   _________________________________ (or virtual meeting link)
...
- Do NOT include any PII, confidential data, security documentation,
  or protected information in any prompt.
- Only use approved AI tools as defined by your organization's AI policy.
...
- User Story Drafting (from requirements context)
...
> **Reference:** Chapter 3 (Governance & Compliance)

One-page reference card for all pilot participants. Print and post at workstations or pin in team communication channel. Customize the approved tools, prohibited data categories, and reporting channel for each engagement.

```
+----------------------------------------------------------------------+
|                    AI GUARDRAILS CHEAT SHEET                           |
|                   [Client / Engagement Name]                          |
|                   USSP / Krasan AI Transformation Framework                  |
+----------------------------------------------------------------------+
|                                                                      |
|  APPROVED TOOLS                                                      |
|  --------------                                                      |
|  YES: [List approved tools per client AI policy]                     |
|  NO:  [List prohibited tools per client AI policy]                   |
|                                                                      |
|  THE GOLDEN RULE                                                     |
|  ---------------                                                     |
...
|  [ ] Confidential client data or case information                    |
|  [ ] Protected health information (HIPAA)                            |
|  [ ] Educational records (FERPA)                                     |
|  [ ] Financial records subject to regulatory protection              |
|  [ ] Security documentation, architecture diagrams, or              |
|      security plans                                                  |
|  [ ] Passwords, API keys, credentials, or access tokens             |
|  [ ] Production database connection strings                          |
|  [ ] [Add client-specific prohibited data categories]                |
|                                                                      |
+----------------------------------------------------------------------+
|                                                                      |
...
|  REPORTING CHANNEL                                                   |
|  -----------------                                                   |
|  [Team communication channel name]                                   |
|  AI Transformation Leader: [Name]                                    |
|  Engagement Director: [Name]                                         |
|                                                                      |
|  Client AI Policy: [Reference -- effective date and compliance       |
...
EVIDENCE
---------
Link to work item, screenshot, metric, or other supporting artifact:
...
|---|----------|----------------|-----------|
| 1 | AI Readiness Assessment (condensed) | Chapter 4 | Pre-pilot, all teams |
...
| 5 | Mid-Pilot Pulse Survey | Chapter 9 | At pilot midpoint |
