---
title: "Scale & Rollout"
description: "Expanding from pilot to organization-wide AI augmentation through phased waves"
---
...
If the pilot proves successful, expand AI augmentation from the pilot teams to all teams across the organization. Scale is based on proven results, not assumptions.

## When This Happens

- **Phase:** Scale
- **Timing:** Next iteration cycle after pilot results are reviewed
- **Deliverable:** Organization-Wide Rollout Plan
...
| Executive approval | Executive sponsor confirms scale is appropriate |
...
Scale happens in waves, not all teams at once:

| Wave | Teams | Timing | Focus |
|------|-------|--------|-------|
| Wave 1 (Pilot) | 2 teams | Pilot cycle | Full framework -- all roles, all processes |
| Wave 2 | 3-4 teams | Next cycle | Proven processes only -- based on pilot results |
| Wave 3 | Remaining teams | Cycle after that | Full rollout with refined playbooks |

Adjust the number of waves based on the total number of teams. For larger organizations, add additional waves as needed to maintain manageable cohort sizes.
...
1. **Foundation track** -- Same for everyone (compliance, guardrails, what success looks like)
...
At scale, measurement shifts from team-level to organization-level:

| What Changes | How |
|-------------|-----|
| No more control group | All teams are now using AI tools |
| Comparison shifts | Current cycle vs pilot cycle vs pre-pilot baseline |
| Frequency | Sprint-level tracking continues; executive report at cycle boundaries |
| Dashboard | tools.ussp.co shows organization-wide view, not just pilot teams |

### Continuous Improvement

- Playbooks updated each cycle based on new learnings
...
- [ ] Work tracking tool configured for new teams
...
> AI augmentation is standard practice across the organization -- not a special project, just how teams work.

- Every BA uses AI for story quality and acceptance criteria generation
- Every tester uses AI for test script creation
- Every developer uses AI for code review and documentation
- Every Scrum Master uses AI for sprint insights
- Playbooks are maintained as living documents
- Measurement continues at the organization level
