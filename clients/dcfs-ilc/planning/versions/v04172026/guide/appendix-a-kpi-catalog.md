...
- **Data Source:** JIRA
- **Collection Method:** Automated -- extracted from JIRA sprint reports
...
- **Data Source:** JIRA
- **Collection Method:** Automated -- calculated from JIRA workflow timestamps
- **Frequency:** Per sprint
...
- **Data Source:** JIRA
- **Collection Method:** Automated -- tracked via JIRA workflow transitions (any move from review back to draft/in-progress)
- **Frequency:** Per sprint
- **Target Direction:** Lower is better
...
- **Data Source:** JIRA
- **Collection Method:** Automated -- tracked via JIRA workflow transitions (stories that move from QA to Done without returning to In Progress)
- **Frequency:** Per sprint
- **Target Direction:** Higher is better
...
- **Data Source:** Zephyr
- **Collection Method:** Automated -- Zephyr traceability report cross-referenced with JIRA stories
- **Frequency:** Per sprint
- **Target Direction:** Higher is better
...
- **Data Source:** JIRA
- **Collection Method:** Automated -- JIRA query for issue type = Bug linked to sprint stories
- **Frequency:** Per sprint
- **Target Direction:** Lower is better
...
- **Data Source:** JIRA
- **Collection Method:** Automated -- JIRA query filtering bugs by environment field (UAT, Production)
- **Frequency:** Per sprint
- **Target Direction:** Lower is better
...
- **Data Source:** JIRA
- **Collection Method:** Automated -- JIRA workflow transition tracking (Done to any active status)
- **Frequency:** Per sprint
- **Target Direction:** Lower is better
...
- **Data Source:** Survey
- **Collection Method:** Manual -- anonymous team survey distributed at the end of each PI (or quarterly)
- **Frequency:** Per PI (Program Increment)
- **Target Direction:** Higher is better
...
- **Description:** Percentage of features with current, up-to-date Confluence documentation
- **Formula:** `COUNT(features_with_current_docs) / COUNT(total_features) * 100`
- **Data Source:** Audit (Confluence)
...
- **Data Source:** JIRA
- **Collection Method:** Automated -- JIRA story point estimate vs. actual (or time estimate vs. time logged)
- **Frequency:** Per sprint
...
- **Data Source:** JIRA
- **Collection Method:** Automated -- JIRA query filtering for component = "Data Migration" and type = Bug
- **Frequency:** Per sprint
- **Target Direction:** Lower is better

### KPI 21 -- Config Documentation

- **Description:** Dynamics 365 configuration documentation completeness
- **Formula:** `COUNT(configs_documented) / COUNT(total_configs) * 100`
- **Data Source:** Confluence
- **Collection Method:** Manual -- audit of Confluence pages against Dynamics 365 configuration registry
- **Frequency:** Per PI
- **Target Direction:** Higher is better
...
- **Data Source:** JIRA
- **Collection Method:** Automated -- JIRA epic/feature timestamps from creation to Done
- **Frequency:** Per PI
- **Target Direction:** Lower is better
...
|---|---|
| **Automated (JIRA)** | JIRA project access, consistent workflow usage, standard field conventions |
| **Automated (Zephyr)** | Zephyr integration active, test cases linked to stories |
...
| **Manual (Audit)** | Confluence access, feature/config registry maintained |
...
|---|---|---|---|---|---|---|
| 1 | Velocity | Sprint velocity | JIRA | Automated | Per sprint | Higher |
| 2 | Velocity | Cycle time | JIRA | Automated | Per sprint | Lower |
| 3 | Velocity | Throughput | JIRA | Automated | Per sprint | Higher |
| 4 | Velocity | Sprint predictability | JIRA | Automated | Per sprint | Higher |
| 5 | Quality | Story quality score | Scanner | Automated | Per sprint | Higher |
| 6 | Quality | Story rejection rate | JIRA | Automated | Per sprint | Lower |
| 7 | Quality | First pass yield | JIRA | Automated | Per sprint | Higher |
| 8 | Quality | Test coverage | Zephyr | Automated | Per sprint | Higher |
| 9 | Quality | Defect density | JIRA | Automated | Per sprint | Lower |
| 10 | Quality | Defect escape rate | JIRA | Automated | Per sprint | Lower |
| 11 | Efficiency | Story review cycle time | JIRA | Automated | Per sprint | Lower |
| 12 | Efficiency | Test creation time | Manual | Manual | Per sprint | Lower |
| 13 | Efficiency | Story authoring time | JIRA | Automated | Per sprint | Lower |
| 14 | Efficiency | Sprint completion rate | JIRA | Automated | Per sprint | Higher |
| 15 | Efficiency | Rework rate | JIRA | Automated | Per sprint | Lower |
| 16 | Team Health | SPACE survey | Survey | Manual | Per PI | Higher |
| 17 | Team Health | Requirement clarity | Survey | Manual | Per sprint | Higher |
| 18 | Team Health | Documentation completeness | Audit | Manual | Per PI | Higher |
| 19 | Team Health | Planning accuracy | JIRA | Automated | Per sprint | Lower |
| 20 | Migration | Migration defect rate | JIRA | Automated | Per sprint | Lower |
| 21 | Migration | Config documentation | Confluence | Manual | Per PI | Higher |
| 22 | Migration | Feature lead time | JIRA | Automated | Per PI | Lower |
