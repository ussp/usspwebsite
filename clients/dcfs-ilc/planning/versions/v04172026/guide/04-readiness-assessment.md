...
This chapter provides a standardized assessment instrument for measuring AI readiness across all 12 SAFe product teams in the DCFS Illinois Connect engagement. The assessment captures quantitative baselines and qualitative insights that directly inform pilot team selection, training design, and post-pilot attitude measurement.

**Audience:** All 160+ consultants across all 12 product teams (BAs, Testers, Developers, Scrum Masters/Leads)
...
Krasan's AI Transformation Framework is being built on the principle that successful AI adoption requires understanding where teams actually are, not where we assume they are. This assessment serves three purposes:

1. **Pilot team selection** -- Identify which team has the right combination of readiness, openness, and SDLC process maturity to serve as the pilot
...
Every consultant across all 12 product teams completes the assessment individually. Responses are confidential at the individual level; results are aggregated and reported at the team level.

### How It Is Distributed

The assessment is distributed electronically (Microsoft Forms or equivalent) with a unique link per team to enable team-level aggregation. Paper copies are available on request. Team leads and Scrum Masters are responsible for ensuring completion within the collection window.
...
- [ ] GitHub Copilot
- [ ] Atlassian Rovo (or Atlassian Intelligence)
- [ ] ChatGPT / GPT-4
- [ ] Google Gemini
- [ ] Claude (Anthropic)
- [ ] Other code completion tools (e.g., Tabnine, Codeium)
...
**E1.** Does your team currently have access to GitHub Copilot licenses?

- [ ] Yes, all team members
- [ ] Yes, some team members
- [ ] No, but licenses have been requested
- [ ] No
- [ ] Unsure

**E2.** Does your team currently have access to Atlassian Rovo?

- [ ] Yes, enabled for the team
- [ ] Partially enabled
- [ ] No, but it is available in our Atlassian instance
- [ ] No
- [ ] Unsure
...
|----------------------|-------|
| Both GitHub Copilot and Atlassian Rovo fully available, no constraints | 5.0 |
| Both tools available, minor constraints | 4.0 |
| One tool available, other in progress | 3.0 |
...
4. **Infrastructure availability** -- Both GitHub Copilot and Atlassian Rovo must be accessible to the pilot team before the pilot begins.
...
This data provides Per4m.AI-comparable quantitative evidence that the framework produces measurable cultural and behavioral change, not just tool usage.
...
| Step | When | Owner |
|------|------|-------|
| Finalize assessment instrument | Before distribution | Krasan AI Transformation Leader |
| Create electronic form (Microsoft Forms) | 2 business days before distribution | Krasan AI Transformation Leader |
| Distribute to all 12 team leads | Day 1 of collection window | Krasan AI Transformation Leader |
...
| Analysis and team scoring | Days 6-8 | Krasan AI Transformation Leader |
| Results presentation to Krasan leadership | Day 10 | Krasan AI Transformation Leader |
...
The Krasan AI Transformation Leader owns analysis and reporting. The analysis deliverable includes:

1. **Team readiness scorecard** -- One page per team showing all sub-scores, readiness tier, and key findings
2. **Cross-team comparison** -- Ranked view of all 12 teams on each dimension
3. **Pilot team recommendation** -- Recommended pilot team with rationale mapped to selection criteria
...
Results are presented to Krasan leadership before the pilot team is formally selected, allowing for discussion and any adjustments based on factors not captured in the assessment (e.g., upcoming team changes, sprint calendar constraints).
