...
## Phase 0 — Governance & Access (this week)
...
| G3 | DoIT 30-day notice — starting email to Dave | Vinay → Dave | Thu Apr 23 | 🔴 | 🔄 | Next action — blocker for pilot start |
| G4 | Section 5e determination — Copilot on source = State data? | Dave | After Apr 22 mtg | 🔴 | ⏳ | Blocker — ask in mtg |
| G5 | Tool availability — GitHub Copilot tier, Rovo tier, M365 Copilot, D365 Copilot | Dave | After Apr 22 mtg | 🔴 | ⏳ | 4 checkboxes |
| G6 | Pilot Governance Charter draft review | Pilot Gov team | Apr 28 | 🟡 | 🔄 | Written, needs sign-off |
| G7 | Pilot Governance Lead — DCFS designee identified | Dave + Jim | Apr 25 | 🔴 | ⏳ | May propose David himself |
| G8 | Security & Privacy Lead (pilot) — DCFS designee | Dave | Apr 30 | 🟡 | ⏳ | Part of MVG 3-seat team |
| G9 | DCFS AI Governance Team Phase B — MVG seated | DCFS | Jul 1 | 🟡 | ⏳ | Hard dependency for scale |
| G10 | Krasan email password reset | Robert / Ryan | Apr 21 | 🟡 | ✅ | Done Apr 21 |
| G11 | Vinay DCFS fingerprinting | Vinay | Apr 22 | 🟡 | ✅ | Done Apr 22 — submitted |
| G12 | Copilot tool limitations — confirm scope with Dave (no web search / sandboxed to tenant) | Vinay → Dave | Apr 25 | 🔴 | 🔄 | Surfaced Apr 22; see `meeting-notes/2026-04-22-dave-meeting.md` |
| G13 | "Copilot boundaries" one-pager + Foundation training module | Vinay | May 1 | 🟡 | ⏳ | Ships with Foundation session |
| G14 | Audit playbooks (BA/Dev/Tester) for web-retrieval assumptions | Vinay | May 3 | 🟡 | ⏳ | Remove any step that relies on live web |
...
| # | Task | Owner | Due | Priority | Status | Notes |
|---|------|-------|-----|----------|--------|-------|
| B1 | Baseline metrics session — finalize candidate set | Vinay + Matt + Jeff + Alec | Apr 21 12:30 CT | 🟡 | ✅ | Done — testing-is-bottleneck finding |
...
| B5 | Baseline survey — questions draft | Vinay | Apr 22 | 🟡 | ⏳ | Qual + quant |
| B6 | Baseline survey — review (John, Jeff, Romi) | John + Jeff + Romi | Apr 24 | 🟡 | ⏳ | After draft |
...
| B10 | Intact pilot team kickoff meeting | Romi + Rina | Apr 28 | 🟡 | ⏳ | Set expectations with 5-6 members |
| B11 | Baseline metrics report | Vinay | Apr 30 | 🟡 | ⏳ | Feeds May 5 PI Planning |
| B12 | Role workflow mapping — BA, Tester, Developer, SA, BA-Tech | Vinay | May 8 | 🟢 | ⏳ | Current-state + AI-augmented state |
| B13 | Role playbooks v0 → v0.5 refinement | Vinay | May 13 | 🟢 | 🔄 | v0 drafts in deliverables/playbooks/ |
...
| T7 | BA-Tech track delivery (2h) | Vinay | Week of May 12 | 🟢 | ⏳ | |
...
| # | Task | Owner | Due | Priority | Status | Notes |
|---|------|-------|-----|----------|--------|-------|
| P1 | Identify pair-programmer roles + order (stair-step) | Vinay + Romi | Apr 25 | 🟡 | ⏳ | BA first? Dev first? |
| P2 | Source pair programmers (Krasan bench) | Dinkar | May 1 | 🔴 | ⏳ | ~5-6 external hires |
| P3 | Confirm DCFS clearance requirements for pair programmers | Dave | After Apr 22 mtg | 🟡 | ⏳ | Ask in mtg |
...
| # | Task | Owner | Due | Priority | Status | Notes |
|---|------|-------|-----|----------|--------|-------|
| E1 | PI 20 Planning — present AI pilot | Romi + Vinay | May 5-7 | 🟡 | ⏳ | |
| E2 | Configure tools.ussp.co — engagement, teams, baseline | Vinay | May 5 | 🟡 | ⏳ | |
| E3 | Share read-only dashboard with Dave | Vinay + Romi | May 5 | 🟢 | ⏳ | |
| E4 | Sprint 2.1 start — training active | Pilot team | May 14 | 🟡 | ⏳ | |
| E5 | Weekly Pilot Governance meeting | Pilot Gov Lead | Every Tue | 🟡 | ⏳ | Per charter |
| E6 | Weekly metrics collection | Vinay | Weekly | 🟡 | ⏳ | Via JIRA + tools |
...
| S4 | Playbooks v1.0 — BA, Tester, Developer, SA, BA-Tech, Data | Vinay | Aug 8 | 🟡 | ⏳ | |
...
|---|------|-------|---------|----------|--------|-------|
| O1 | Weekly status update to Dave | Vinay + Romi | Weekly | 🟡 | ⏳ | Format TBC in Apr 22 mtg |
...
|-------|------|-------------|------|---------|-------|
| 0 Governance | 8 | 2 | 1 | 5 | 11 |
| 1 Baseline | 11 | 2 | 1 | 0 | 13 |
| 2 Train | 8 | 0 | 0 | 0 | 8 |
| 3 Pair Programming | 5 | 0 | 0 | 1 | 5 |
