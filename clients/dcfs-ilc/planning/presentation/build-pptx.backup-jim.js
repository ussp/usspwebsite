...
// Three columns
const cols5 = [
  { title: 'Govern', items: ['Review DoIT AI Policy — all 12 sections mapped', 'Define data guardrails (no case data, no PII in any AI tool)', 'Confirm approved tools & licensing status', 'Align on constraints: HITL on all AI output, no autonomous AI commits, SDLC only'], deliverable: 'AI Usage Playbook & Compliance Map' },
