...
> **Purpose:** Short 1-page memo for David to share. Conveys the essentials DoIT needs under §5f without appendix detail. Pair with the **detailed version** (`doit-30day-notice-detailed-v20260428.docx`) as supporting material if requested.
> **Who signs:** Jim Daugherty (DCFS CIO).
> **Draft owner (final):** DCFS policy lead (to be named).
> **Version:** V20260428 (v0.2 light)
> **Change vs v0.1 (Apr 23):** Added Zephyr Scale Agent for Atlassian Rovo as a fifth covered tool (surfaced in the Apr 24 testing-workflow walkthrough — highest-value tester acceleration). Same data envelope as Rovo. Detailed version updated in lockstep.
...
- **Zephyr Scale Agent for Atlassian Rovo** (licensing scoping) — extends Rovo by writing AI-generated test cases directly into Zephyr Scale folders linked to JIRA stories (replaces manual copy-paste from a JIRA comment). Same data envelope as Rovo.
...
*Detailed assessment available on request — see `doit-30day-notice-detailed-v20260428` for compliance map, governance structure, risks, and mitigations.*
